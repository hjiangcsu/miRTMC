...
The source code of miRTMC is compiled by MATLAB 2015b (64-bit version). Before you run this program on your computer, verify the MATLAB Runtime version 9.0 (R2015b) is installed.

You can download MATLAB Runtime version 9.0 (R2015b) from the MathWorks Web site:   http://www.mathworks.com/products/compiler/mcr/index.html

Step 1. Install MATLAB Runtime version 9.0 (R2015) (if your computer has MATLAB 2015b installed, ignore this step)
(1) Run MCR_R2015b_win64_installer.exe;
...
(2) Change the directory to the fold that including miRTMC_windows.exe, para.txt and dataset files.
...
Step 1. Install MATLAB Runtime version 9.0 (R2015) for Linux
(1) create a tmp fold for unzip the file MCR_R2016b_glnxa64_installer.zip by using the following command:
      mkdir tmp
      mv MCR_R2015b_glnxa64_installer.zip ./tmp 
      cd ./tmp
      unzip MCR_R2015b_glnxa64_installer.zip -d MCRInstaller 
...
export LD_LIBRARY_PATH=$MCR_HOME/v90/runtime/glnxa64:$MCR_HOME/v90/bin/glnxa64:$MCR_HOME/v90/sys/java/jre/glnxa64/jre/lib/amd64/server:$MCR_HOME/v90/sys/os/glnxa64:$MCR_HOME/v90/sys/java/jre/glnxa64/jre/lib/amd64:$MCR_HOME/v90/sys/java/jre/glnxa64/jre/lib/amd64/native_threads
export XAPPLRESDIR=$MCR_HOME/v90/X11/app-defaults
